...
export default function Home() {
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900 text-gray-100 overflow-hidden pt-14">
      {/* Navigation Header */}
      <nav className="fixed top-0 w-full z-50 backdrop-blur-sm bg-white/5 px-4 py-2 flex justify-between items-center border-b border-white/10 shadow-md">
        <h1 className="text-lg font-bold text-gray-100">My Portfolio</h1>
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute bottom-16 right-16 w-32 h-32 bg-purple-500/20 rounded-full blur-xl animate-pulse delay-700"></div>
      </div>

      <header className="text-center mb-8 z-10 backdrop-blur-sm bg-white/5 p-6 rounded-2xl border border-white/10 shadow-lg transform hover:scale-105 transition-all duration-300">
        <div className="relative group flex justify-center">
          <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full blur opacity-50 group-hover:opacity-100 transition duration-300 w-[160px] h-[160px]"></div>
          <Image
            src="/subomi.png"
            alt="Profile Picture"
            width={150}
        ...
        <p className="text-lg text-gray-300 mt-1 tracking-wider">
      ...
      <main className="text-center max-w-xl z-10 space-y-6 px-4">
        ...
        <div className="flex justify-center gap-4 mt-8">
          <a
            ...
            className="group relative px-4 py-2 overflow-hidden rounded-xl bg-gradient-to-r from-blue-500 to-blue-600 text-white font-medium shadow-lg hover:shadow-xl transition-all duration-300"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group relative px-4 py-2 overflow-hidden rounded-xl bg-gradient-to-r from-purple-500 to-purple-600 text-white font-medium shadow-lg hover:shadow-xl transition-all duration-300"
          >
      ...
      <footer className="mt-12 text-sm text-gray-400 z-10 backdrop-blur-sm bg-white/5 px-4 py-2 rounded-full">
